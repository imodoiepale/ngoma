...
CURATED: dict[tuple[str, str], tuple[str, str]] = {
    ...
    ("consistent-room", "image"): ("one shot of the character", "the subject that gets placed in the room"),
    ...
    ("h3-reference-image", "references"): ("face, body, outfit and room photos", "an H3 still that keeps all four"),
